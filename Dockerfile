...
RUN apk add --no-cache --update sudo openjdk13 apache-ant build-base bash busybox-extras libffi-dev tcpdump libpcap-dev iptables curl libpq-dev libc6-compat
RUN pip3 install "scapy[basic]" pcapy-ng impacket sqlalchemy psycopg2 jsons pyyaml pyright
